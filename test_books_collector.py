...
def test_new_book_has_empty_genre(collector):
    collector.add_new_book('Ребекка')
...
def test_set_book_genre(collector, genre):
...
def test_books_with_age_rating_not_for_children(collector, genre):
...
def test_add_book_to_favorites_only_once(collector):
    collector.add_new_book('Ребекка')
